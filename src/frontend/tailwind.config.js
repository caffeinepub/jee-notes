  ...
  theme: {
    ...
    extend: {
      ...
      colors: {
        ...
        navy: { dark: "oklch(var(--navy-dark))", mid: "oklch(var(--navy-mid))", active: "oklch(var(--navy-active))" },
        teal: { DEFAULT: "oklch(var(--teal))" },
      },
      borderRadius: { lg: "var(--radius)", md: "calc(var(--radius) - 2px)", sm: "calc(var(--radius) - 4px)" },
      boxShadow: {
        card: "0 1px 3px 0 rgba(22,58,89,0.07), 0 1px 2px -1px rgba(22,58,89,0.05)",
        "card-hover": "0 4px 12px 0 rgba(22,58,89,0.12), 0 2px 4px -2px rgba(22,58,89,0.08)",
      },
      keyframes: {
